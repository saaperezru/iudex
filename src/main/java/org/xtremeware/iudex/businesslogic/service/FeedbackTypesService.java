...
public class FeedbackTypesService extends SimpleCrudService<FeedbackTypeVo, FeedbackTypeEntity> {
    ...
    /**
     * returns the FeedbackTypeDaoInterface to be used.
     *
     * @return
     */
    @Override
    protected CrudDaoInterface<FeedbackTypeEntity> getDao() {
    ...
    public List<FeedbackTypeVo> list(EntityManager em) {
        List<FeedbackTypeEntity> feedbackTypeEntitys = ((FeedbackTypeDaoInterface) this.getDao()).getAll(em);
