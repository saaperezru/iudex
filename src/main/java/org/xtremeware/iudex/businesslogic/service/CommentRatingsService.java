...
public class CommentRatingsService extends SimpleCrudService<CommentRatingVo, CommentRatingEntity> {
    ...
    public CommentRatingEntity voToEntity(EntityManager em, CommentRatingVo vo) throws InvalidVoException {
        ...
        commentRatingEntity.setUser(this.getDaoFactory().getUserDao().getById(em, vo.getUser()));
        commentRatingEntity.setComment(this.getDaoFactory().getCommentDao().getById(em, vo.getEvaluetedObjectId()));
