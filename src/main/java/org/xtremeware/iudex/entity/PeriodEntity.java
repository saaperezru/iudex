...
@NamedQueries({
    @NamedQuery(name = "getPeriodsByYear",
    query = "SELECT p FROM Period p WHERE p.year = :year"),
    @NamedQuery(name = "getPeriodByYearAndSemester",
    query = "SELECT p FROM Period p WHERE p.year = :year AND p.semester = :semester"),
    @NamedQuery(name = "getAllPeriods",
