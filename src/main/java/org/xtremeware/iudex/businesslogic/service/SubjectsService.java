...
public class SubjectsService extends SimpleCrudService<SubjectVo, SubjectEntity> {
    ...
    /**
     * returns the SubjectDaoInterface to be used.
     *
     * @return
     */
    @Override
    protected CrudDaoInterface<SubjectEntity> getDao() {
   ...
   /**
    ...
    public List<SubjectVo> search(EntityManager em, String query) {
        ...
        List<SubjectEntity> subjectEntitys = ((SubjectDaoInterface) this.getDao()).getByName(em, query);
    ...
    public List<SubjectVo> getByNameLike(EntityManager em, String name) {
        ...
        List<SubjectEntity> subjectEntitys = ((SubjectDaoInterface) this.getDao()).getByName(em, name);
        if (subjectEntitys.isEmpty()) {
            return null;
        }
        ArrayList<SubjectVo> arrayList = new ArrayList<SubjectVo>();
