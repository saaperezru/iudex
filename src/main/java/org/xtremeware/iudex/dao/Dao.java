...
public abstract class Dao<E extends Entity> {
	...
	/**
	 * Returns the received Entity after being merged in the EntityManager
	 * em
	 *
	 * @param em EntityManager with which the entity will be persisted
...
**/
	private Class returnedClass() {
		return getTypeArguments(Dao.class, getClass()).get(0);
	}
	/**
	 * Get the underlying class for a type, or null if the type is a
	 * variable type. Taken from
