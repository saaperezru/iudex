...
public class FeedbackDao extends Dao<FeedbackEntity> {
	...
	/**
	 * Returns a list of Feedback with a type corresponding to the specified feedbackTypeId
	 *
	 * @param em EntityManager with which the entities will be searched
	 * @param feedbackTypeId Feedback type identifier to look for in feedback entities.
