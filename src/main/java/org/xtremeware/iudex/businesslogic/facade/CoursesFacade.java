...
public class CoursesFacade extends AbstractFacade {
	...
	public CourseVo addCourse(long professorId, long subjectId, long periodId) throws InvalidVoException {
	...
	public CourseRatingVo rateCourse(long courseId, long userId, float value) throws InvalidVoException {
		EntityManager em = null;
		EntityTransaction tx = null;
