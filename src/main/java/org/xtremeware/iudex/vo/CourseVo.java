...
public class CourseVo implements ValueObject{
	...
	public boolean equals(Object obj) {
		...
		if (this.ratingAverage != other.ratingAverage && (this.ratingAverage == null || !this.ratingAverage.equals(other.ratingAverage))) {
			return false;
		}
	...
	public String toString() {
		return "CourseVo{" + "id=" + id + ", professorId=" + professorId + ", subjectId=" + subjectId + ", periodId=" + periodId + ", ratingAverage=" + ratingAverage + ", ratingCount=" + ratingCount + '}';
	}
