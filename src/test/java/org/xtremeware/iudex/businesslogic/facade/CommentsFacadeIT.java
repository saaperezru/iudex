...
public class CommentsFacadeIT {
    ...
    public void setUp() {
        ...
        exceptionMessageComment.add("String Content in the provided CommentVo cannot be null");
        exceptionMessageComment.add("Long CourseId in the provided CommentVo cannot be null");
        exceptionMessageComment.add("Long CourseID in the provided CommentVo does not have matches with existent courses");
        exceptionMessageComment.add("Date Date in the provided CommentVo cannot be null");
        exceptionMessageComment.add("Long UserId in the provided CommentVo cannot be null");
        exceptionMessageComment.add("Long UserId in the provided CommentVo does not have matches with existent users");
        exceptionMessageComment.add("Float Rating in the provided CommentVo cannot be null");
        exceptionMessageComment.add("Float Rating in the provided CommentVo must be greater or equal than 0.0 and less or equal than 5.0");
        exceptionMessageComment.add("String Content length in the provided CommentVo must be grater or equal than 1 and less or equal than 20");
        ...
        exceptionMessageCommentR.add("Null commentId in the provided CourseRatingVo");
        exceptionMessageCommentR.add("No such comment associeted with CommentRatingVo.commentId");
        exceptionMessageCommentR.add("Null userId in the provided CommentRatingVo");
        exceptionMessageCommentR.add("No such user associated with CommentRatingVo.userId");
        exceptionMessageCommentR.add("int Value in the provided CommentRatingVo "
     ...
     */
    @Test
    public void test_BL_5_1() throws InvalidVoException, MultipleMessageException {
    ...
    @Test
    public void test_BL_5_2_1() throws MultipleMessageException {
        CommentsFacade commentsFacade = Config.getInstance().getFacadeFactory().getCommentsFacade();
        try {
            CommentVo result = commentsFacade.addComment(null);
        } catch (MultipleMessageException ex) {
            assertEquals("Null CommentVo", ex.getExceptions().get(0).getMessage());
        }
        CommentVo commentVo = new CommentVo();
        commentVo.setAnonymous(true);
        ...
        try {
            ...
            for (Exception e : ex.getExceptions()) {
                assertTrue(exceptionMessageComment.contains(e.getMessage()));
            }
        }
        commentVo.setContent("Entrada muy larga, muy muy largaEntrada muy larga, muy muy larga");
    ...
    @Test
    public void test_BL_5_3() throws MultipleMessageException {
        CommentVo commentVo = new CommentVo();
        commentVo.setAnonymous(true);
        commentVo.setContent("bueno");
        commentVo.setCourseId(4L);
        ...
        try {
            ...
            assertEquals(MaxCommentsLimitReachedException.class, e.getExceptions().get(0).getClass());
            assertEquals("Maximum comments per day reached", e.getExceptions().get(0).getMessage());
        }

    }

    @Test
    public void test_BL_7_1() throws MultipleMessageException {
        Long commmendId = 2L;
        Long userId = 2L;
        int value = 1;
        CommentsFacade commentsFacade = Config.getInstance().getFacadeFactory().getCommentsFacade();
        CommentRatingVo commentRatingVo = commentsFacade.rateComment(commmendId, userId, value);
        ...
        int size = entityManager.createQuery("SELECT COUNT(c) FROM CommentRating c WHERE c.id = :id", Long.class).
                setParameter("id", commentRatingVo.getId()).getSingleResult().intValue();
        assertEquals(1, size);
    }

    @Test
    public void test_BL_7_2() throws MultipleMessageException {
        Long commmendId = 5L;
        Long userId = 1L;
        int value = 1;
        CommentsFacade commentsFacade = Config.getInstance().getFacadeFactory().getCommentsFacade();
        try {
            ...
            for (Exception e : ex.getExceptions()) {
                assertTrue(exceptionMessageCommentR.contains(e.getMessage()));
            }
        }
    }

    @Test
    public void test_BL_7_3() throws MultipleMessageException {
        Long commmendId = 2L;
        Long userId = 1L;
        int value = 1;
        CommentsFacade commentsFacade = Config.getInstance().getFacadeFactory().getCommentsFacade();
        ...
        assertEquals(userId, commentRatingVo.getUser());
        value = -1;
        CommentRatingVo result = commentsFacade.rateComment(commmendId, userId, value);
    ...
    @Test
    public void test_BL_7_4() throws MultipleMessageException {
        Long commmendId = 2L;
        Long userId = 3L;
        int value = 1;
        CommentsFacade commentsFacade = Config.getInstance().getFacadeFactory().getCommentsFacade();
    ...
    public void test_BL_22_1() {
        ...
        commmendId = 10L;
        commentRatingSummary = commentsFacade.getCommentRatingSummary(commmendId);
    ...
    public void test_BL_23_1() throws DataBaseException {
        ...
        int size = entityManager.createQuery("SELECT COUNT(c) FROM Comment c WHERE c.course.id = :id", Long.class).
                setParameter("id", id).getSingleResult().intValue();
        assertEquals(2, size);
        for(CommentVoVwFull cvvf:commentsByCourseId){
            CommentVo result = entityManager.createQuery("SELECT c FROM Comment c WHERE c.id = :id", CommentEntity.class).
    ...
    public void test_BL_24_1() throws DataBaseException {
        ...
        int value = entityManager.createQuery("SELECT c.value FROM CommentRating c WHERE c.comment.id = :commentId AND c.user.id = :userId", Integer.class).
    ...
    public void test_BL_24_2() throws DataBaseException {
        ...
        userId = 0L;
        commentId = 1L;
        commentRatingByUserId = commentsFacade.getCommentRatingByUserId(commentId, userId);
        assertNull(commentRatingByUserId);
    ...
    public void test_BL_25_1() throws Exception {
        ...
        Long singleResult = entityManager.createQuery("SELECT COUNT(c) FROM Comment c WHERE c.id = :commmendId", Long.class).setParameter("commmendId", commmendId).getSingleResult();
        assertEquals(0,singleResult.intValue());
        singleResult = entityManager.createQuery("SELECT COUNT(c) FROM CommentRating c WHERE c.comment.id = :commmendId", Long.class).setParameter("commmendId", commmendId).getSingleResult();
        assertEquals(0,singleResult.intValue());
    }
    ...
    public void test_BL_25_2() throws Exception {
        ...
        try {
            ...
            assertEquals("No entity found for id " + String.valueOf(commmendId) + "while triying to delete the associated record", ex.getMessage());
            Long singleResult = entityManager.createQuery("SELECT COUNT(c) FROM Comment c WHERE c.id = :commmendId", Long.class).setParameter("commmendId", commmendId).getSingleResult();
            assertEquals(0,singleResult.intValue());
            singleResult = entityManager.createQuery("SELECT COUNT(c) FROM CommentRating c WHERE c.comment.id = :commmendId", Long.class).setParameter("commmendId", commmendId).getSingleResult();
            assertEquals(0,singleResult.intValue());
