...
public class ProfessorRatingService extends SimpleCrudService<ProfessorRatingVo, ProfessorRatingEntity> {

	public ProfessorRatingService(AbstractDaoFactory daoFactory) {
		super(daoFactory);
	}
