...
public interface CourseDao extends CrudDao<CourseEntity> {
     ...
     */
    List<CourseEntity> getByProfessorId(EntityManager entityManager, long professorId)
     ...
     * @return The list of found courses.
     */
    List<CourseEntity> getBySubjectId(EntityManager entityManager, long subjectId)
            throws DataBaseException;
     ...
     * @return The list of found courses.
     */
    List<CourseEntity> getByPeriodId(EntityManager entityManager, long periodId)
            throws DataBaseException;
     ...
     * @return The list of found courses.
     */
    List<CourseEntity> getByProfessorIdAndSubjectId(EntityManager entityManager,
     ...
     */
    List<CourseEntity> getCoursesByProfessorNameLikeAndSubjectNameLike(
