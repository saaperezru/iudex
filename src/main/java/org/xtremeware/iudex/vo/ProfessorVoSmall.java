...
public class ProfessorVoSmall implements ValueObject {

    private long id;
    private String fullName;
    private RatingSummaryVo ratingSummary;

    public ProfessorVoSmall(long id, String fullName, RatingSummaryVo ratingSummary) {
        this.id = id;
        this.fullName = fullName;
        this.ratingSummary = ratingSummary;
    }

    public ProfessorVoSmall(ProfessorVo professorVo, RatingSummaryVo ratingSummary) {
        this.id = professorVo.getId();
        this.fullName = professorVo.getFirstName()+" "+professorVo.getLastName();
        this.ratingSummary = ratingSummary;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ProfessorVoSmall other = (ProfessorVoSmall) obj;
        if (this.id != other.id) {
            return false;
        }
