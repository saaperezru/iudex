...
CREATE INDEX FORGOTTEN_PASSWORD_KEY_FKIndex1 ON FORGOTTEN_PASSWORD_KEY( ID_USER_ );
...
INSERT INTO USER_ (ID_USER_,ACTIVE,FIRST_NAMES,LAST_NAMES,PASSWORD_,ROLE_,USER_NAME) VALUES (1,1,'Administrator','Administrator','15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225',1,'administrator');
INSERT INTO USER_ (ID_USER_,ACTIVE,FIRST_NAMES,LAST_NAMES,PASSWORD_,ROLE_,USER_NAME) VALUES (2,1,'Student 1','Student 1','15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225',0,'student1'); -- BL-3.1, BL-3.2
INSERT INTO USER_ (ID_USER_,ACTIVE,FIRST_NAMES,LAST_NAMES,PASSWORD_,ROLE_,USER_NAME) VALUES (3,0,'Student 2','Student 2','15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225',0,'student2'); -- BL-10.1
INSERT INTO USER_ (ID_USER_,ACTIVE,FIRST_NAMES,LAST_NAMES,PASSWORD_,ROLE_,USER_NAME) VALUES (4,0,'Student 3','Student 3','15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225',0,'student3'); -- BL-3.3
INSERT INTO USER_ (ID_USER_,ACTIVE,FIRST_NAMES,LAST_NAMES,PASSWORD_,ROLE_,USER_NAME) VALUES (5,1,'Student 4','Student 4','15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225',0,'student4'); -- BL-11.1
INSERT INTO USER_ (ID_USER_,ACTIVE,FIRST_NAMES,LAST_NAMES,PASSWORD_,ROLE_,USER_NAME) VALUES (6,1,'Student 5','Student 5','15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225',0,'student5'); -- BL-2.3
...
INSERT into COURSE values ('3','1','2016025','1','3.1','4');-- BL_19_1. Deleted in this test. Don't use it.
--FABIO COURSES
INSERT into COURSE values ('4','2','2019772','1','3.7','4');-- BL_19_1. Deleted in this test. Don't use it.
--ALVARO COURSES
INSERT into COURSE values ('5','3','2016025','1',0,0);
INSERT into COURSE values ('6','3','2019855','1','4.0','4');
INSERT into COURSE values ('7','3','2021814','7','4.2','4');
...
-- COMMENTS FOR DELETE
INSERT into COMMENT_ values ('5','1','2','Muy buen curso','2012-01-26 14:43:24','4.5','0');
INSERT into COMMENT_ values ('6','2','3','PÉSIMO curso','2012-01-26 14:43:24','2.5','0');
INSERT into COMMENT_ values ('7','2','4','áño <script> for (;;){alert(1);}</script>','2012-01-26 14:43:24','2.5','0');
INSERT into COMMENT_ values ('8','1','5','áño <script> for (;;){alert(1);}</script>','2012-01-26 14:43:24','4.5','1');
...
-- RATINGSCOMMENTS FOR DELETE
INSERT into COMMENT_RATING values ('5','5','1','-1');
INSERT into COMMENT_RATING values ('6','6','2','1');
INSERT into COMMENT_RATING values ('7','7','3','1');
INSERT into COMMENT_RATING values ('8','8','4','-1');
