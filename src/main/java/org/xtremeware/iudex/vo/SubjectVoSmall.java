...
public class SubjectVoSmall implements ValueObject {
    ...
    public SubjectVoSmall(long id, String name, int code, RatingSummaryVo ratingSummary) {
        this.id = id;
        this.name = name;
    ...
    public SubjectVoSmall(SubjectVo subjectVo, RatingSummaryVo ratingSummary) {
        this.id = subjectVo.getId();
        this.name = subjectVo.getName();
        this.ratingSummary = ratingSummary;
        this.code = subjectVo.getCode();
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SubjectVoSmall other = (SubjectVoSmall) obj;
        if (this.id != other.id) {
            return false;
        }
